  ...
  <svg class="moon" fill="none" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"><defs/><path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"/></svg>
   ...
   <div class="left-side">
     <div class="navigation">
       <a href="https://" class="nav-link icon">
   ...
   <div class="app-main">
     <div class="video-call-wrapper">
       <div class="video-participant">
         ...
         <a href="https://" class="name-tag">Andy Will</a>
       ...
       <div class="video-participant">
         ...
         <a href="https://" class="name-tag">Emmy Lou</a>
       ...
       <div class="video-participant">
         ...
         <a href="https://" class="name-tag">Tim Russel</a>
       ...
       <div class="video-participant">
         ...
         <a href="https://" class="name-tag">Jessica Bell</a>
       ...
       <div class="video-participant">
         ...
         <a href="https://" class="name-tag">Ryan Patrick</a>
       ...
       <div class="video-participant">
         ...
         <a href="https://" class="name-tag">Tina Cate</a>
      ...
      <div class="chat-area">
         ...
         <div class="message-wrapper">
          ...
          <div class="message-content">
            ...
            <div class="message">Hello! Can you hear me?🤯 <a class="mention" href="https://">@ryanpatrick</a></div>
          </div>
        </div>
        <div class="message-wrapper">
          <div class="profile-picture">
        ...
        <div class="message-wrapper reverse">
         ...
         <div class="message-wrapper">
          ...
          <div class="message-content">
            ...
            <div class="message">I downloaded the file <a class="mention" href="https://">@timrussel</a></div>
          </div>
        </div>
         <div class="message-wrapper reverse">
          <div class="profile-picture">
